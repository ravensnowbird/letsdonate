...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { food_donor_id: @list_item.food_donor_id, name: @list_item.name, quantity: @list_item.quantity }
    end
  ...
  test "should update list_item" do
    patch :update, id: @list_item, list_item: { food_donor_id: @list_item.food_donor_id, name: @list_item.name, quantity: @list_item.quantity }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
